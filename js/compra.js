            ...
            data.forEach(c => {
                ...
                cuerpo.innerHTML += `
                    <tr>
                        ...
                        <td data-label="Precio Unitario"><strong>$${c.detalle_compra && c.detalle_compra[0]?.precio_unitario ? parseFloat(c.detalle_compra[0].precio_unitario).toFixed(2) : '0.00'} MXN</strong></td>
                        <td data-label="Total"><strong>$${parseFloat(c.total).toFixed(2)} MXN</strong></td>
